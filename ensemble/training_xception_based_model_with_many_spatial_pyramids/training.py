...
def create_callbacks():
    ...
    model_checkpoint_callback = tf.keras.callbacks.ModelCheckpoint(
        filepath=os.path.join(logdir, 'xception_based_model_with_many_pyramids_best_checkpoint.hdf5'),
        monitor="val_loss",
        verbose=1,
        save_best_only=True,
        period=1,
...
if __name__ == "__main__":
    ...
    print("TRAINING ONLY THE DECODER LAYERS USING ADDITIONAL DATA")
    optimizer = tf.keras.optimizers.Adam(lr=1e-2)
    base_model = XceptionSpatialPyramid(input_shape=(input_size, input_size, 3), optimizer=optimizer)
    ...
    print("TRAINING ALL LAYERS USING ADDITIONAL DATA")
    ...
    print("FINE-TUNING ALL LAYERS USING COMPETITION DATA")
    ...
    plt.suptitle("Qualitative Evaluation of Some Validation Data - Input Image, Label, and Prediction")
    plt.show()
